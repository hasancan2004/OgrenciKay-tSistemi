...
namespace Ogrenci_Kayit_Sistemi
{
    public partial class FrmOgretmenDetay : Form
    {
        ...
        void SinifDurumu()
        {
            ...
            int kalan_sayisi = 0;
            int gecen_sayisi = 0;
            for(int say = 0;say <= versay;say++) 
            {
                if (dataGridView1.Rows[say].Cells[8].Value.ToString() == "False")
                {
                    kalan_sayisi++;
                }
                else
            ...
            LblGecenSayisi.Text = gecen_sayisi.ToString();
            LblKalanSayisi.Text= kalan_sayisi.ToString();
        }
    }
}
